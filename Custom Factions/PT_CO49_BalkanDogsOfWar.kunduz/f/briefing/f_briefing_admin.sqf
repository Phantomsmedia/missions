...
_customText = "Read this to the mission dev unless Jani is there, then he'll read it.
<br/>
The entire contract is a cover up, your Indian contact wants your real objective to be utterly secret. Only you, the commander, should know of the true mission, and execute it. The pilots that crashed didn't actually crash, they were working for us. They landed the helicopter. The intel isn't the objective either. We want you to get to the crash site, killing all opposition, and fire the scud missile that is located there. Fire it at TRP 09, directly on top of that target reference point. You will be paid 20 million USD upon completion of this task. The payload of the missile, and the reason for the strike will not be disclosed to you.";
